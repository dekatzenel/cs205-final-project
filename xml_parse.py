...
#Change filename to import different file
#Or convert entire file to importable function for master code
filename = 'fri26.xml'
...
for vertex in vertices:
    ...
    vertex_index += 1
#Consider saving to JSON or somesuch if used independently
